...
- **Adhere to the [Style Guide](../contributing/style-guide)**
...
- **Maintain Original Formatting:** Refer to the [style guide](../contributing/style-guide).
...
- Go to GitHub documents list and select the assigned document, eg: [Dai FAQ](../faqs/dai).
